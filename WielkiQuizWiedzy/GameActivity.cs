...
namespace WielkiQuizWiedzy
{
    ...
    public class GameActivity: Activity, SeekBar.IOnSeekBarChangeListener
    {
        ...
        private String getPlayMode() {  
            if (seekBar.Progress == 0) return Commonn.MODE.EASY.ToString();  
            else if (seekBar.Progress == 1) return Commonn.MODE.MEDIUM.ToString();  
            else if (seekBar.Progress == 2) return Commonn.MODE.HARD.ToString();  
            else return Commonn.MODE.HARDEST.ToString();  
        }  
